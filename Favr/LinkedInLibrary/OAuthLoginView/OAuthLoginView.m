...
#define API_KEY_LENGTH 1       //12
#define SECRET_KEY_LENGTH 1    //16
...
- (IBAction)cancelLinkedInLogin:(id)sender {
...
- (void)requestTokenFromProvider
{
    ...
    OARequestParameter *nameParam = [[OARequestParameter alloc] initWithName:@"scope" value:@"r_fullprofile+rw_nus+r_network+r_emailaddress+w_messages"];
    NSArray *params = [NSArray arrayWithObjects:nameParam, nil];
    [request setParameters:params];
    OARequestParameter * scopeParameter=[OARequestParameter requestParameter:@"scope" value:@"r_fullprofile rw_nus r_network r_emailaddress w_messages"];
...
- (void)requestTokenResult:(OAServiceTicket *)ticket didFinish:(NSData *)data 
{
    ...
    tokenKey = [NSString stringWithFormat:@"%@",self.requestToken.key];
...
{
    apikey = @"750dipz09u9ctb";
    secretkey = @"dhG3pL9UGHlpXMYL";
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    tokenKey = [[NSUserDefaults standardUserDefaults] objectForKey:@"TokenKey"];
